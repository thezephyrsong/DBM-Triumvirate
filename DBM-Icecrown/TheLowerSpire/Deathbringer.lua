...
mod:RegisterEventsInCombat(
	...
	"SPELL_AURA_APPLIED 72293 72385 72441 72442 72443 72737",
...
local specWarnScentofBlood	= mod:NewSpecialWarningSpell(72769, nil, nil, nil, nil, nil, 3)

local timerCallBloodBeast	= mod:NewNextTimer(40, 72173, nil, nil, nil, 1, nil, DBM_COMMON_L.DAMAGE_ICON, nil, 3)
local timerNextScentofBlood	= mod:NewNextTimer(10, 72769, nil, nil, nil, 2)
...
function mod:SPELL_CAST_SUCCESS(args)
	...
	elseif args:IsSpellID(72385, 72441, 72442, 72443) then
		self.vb.boilingBloodIcon = 1
...
function mod:SPELL_SUMMON(args)
	if args:IsSpellID(72172, 72173) or args:IsSpellID(72356, 72357, 72358) then
