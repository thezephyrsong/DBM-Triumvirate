...
This project continues 5Buttons's DBM for Chromiecraft/AzerothCore based on the Warmane DBM by [Zidras](https://github.com/Zidras/DBM-Warmane)

[Download](https://github.com/thezephyrsong/DBM-Triumvirate/archive/refs/heads/main.zip)
...
- Bonkywonky for starting it
- Yuna for giving Dev insight
...
[![Game Version](https://img.shields.io/badge/wow-3.3.5-blue.svg)](https://github.com/thezephyrsong/DBM-Triumvirate/)
[![GitHub Actions](https://github.com/Zidras/DBM-Warmane/workflows/lint/badge.svg?branch=main&event=push)](https://github.com/thezephyrsong/DBM-Triumvirate/actions?query=workflow%3Alint+branch%3Amain)
...
1. Download the addon from the **main** repository (https://github.com/thezephyrsong/DBM-Triumvirate/archive/refs/heads/main.zip).
2. Inside the zip file, open DBM-Warmane-main. Copy/Paste all those folders (DBM-Core, DBM-GUI, etc) into your addons folder (Interface/Addons). DO NOT put the DBM-Triumvirate-main folder directly into the addon folder, it will not work.
...
1. Download the addon from the **main** repository (https://github.com/thezephyrsong/DBM-Triumvirate/archive/refs/heads/main.zip).
2. Inside the zip file, open DBM-Triumvirate-main. Select all the folders (DBM-Core, DBM-GUI, etc) and press Copy (Ctrl+C).
...
4. On your addons folder (Interface/Addons), Paste (Ctrl+V) the previously copied folders here. DO NOT put the DBM-Triumvirate-main folder directly into the addon folder, it will not work.
...
# Problems
* If you've discovered something that's clearly wrong, or if you get an error, please create a [ticket](https://github.com/thezephyrsong/DBM-Triumvirate/issues).
