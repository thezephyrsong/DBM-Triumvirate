...
DBM = {
	Revision = parseCurseDate("2026090100000"),
	DisplayVersion = "10.2.2 alpha", -- the string that is shown as version
	ReleaseRevision = releaseDate(2026, 09, 01) -- the date of the latest stable version that is available, optionally pass hours, minutes, and seconds for multiple releases in one day
}
